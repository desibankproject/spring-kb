	...
	<section>
		...
		<table>
			...
			<td>&nbsp;</td>
				...
				<tr>
				<td>&nbsp;</td>
				<td><button type="submit" class="btn btn-primary">Check User</button> &nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/register-employee"><button type="button" class="btn btn-primary">Sign Up</button></a></td>
				<td></td>
			</tr>
		</table>
		</form>
